...
function Navbar() {
  ...
  return (
    <footer className="h-20 min-w-full bg-white fixed bottom-0 border-t-[1px] border-gray-50 flex items-center flex-shrink-0 z-20">
      <div className="w-full flex justify-around items-center h-10">
        {renderIcons()}
      </div>
    </footer>
  );
